...
\begin{itemize}
\item \textbf{Area (SQFT):} SHAP importance score of 0.282770. Property size shows the strongest intuitive relationship with price, confirming that Area is the primary fundamental driver. Larger units directly correlate with higher transaction values, reflecting Singapore's premium on space.

\item \textbf{Project Name (Encoded):} SHAP importance score of 0.108278. This factor captures the residual price premium associated with specific developer reputation and amenity levels, after accounting for size and general location. It signifies the market's trust in established brands and quality assurance.

\item \textbf{Type of Sale (Resale):} SHAP importance score of 0.097109. This factor segments the market based on transaction type, reflecting the distinct pricing dynamics between new launches (primary market) and resale properties (secondary market), often reflecting market conditions and property age factors.
\end{itemize}
